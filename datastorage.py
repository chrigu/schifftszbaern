...
class DataStorage(object):
    ...
    def load_data(self):
        ...
        return old_rain, old_last_rain, old_last_dry, old_snow, old_data_queue


    def save_data(self, last_update, queue_to_save, rain_now, last_dry, last_rain, next_hit, intensity, snow):
